...
resource "helm_release" "aws_load_balancer_controller" {
  ...
  # Wait for resources to be ready before marking as complete
  wait          = true
  wait_for_jobs = true
  timeout       = 600
...
# Prometheus + Grafana - DISABLED (resource constraints on t3.small)
# To enable: uncomment this block and run terraform apply
