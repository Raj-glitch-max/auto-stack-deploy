  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (err.response?.status === 409) {
        ...
        setMessage("Too many signup attempts. Please wait a moment and try again.")
    ...
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950/20 to-black flex items-center justify-center px-4 py-12">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400">Start deploying with confidence in seconds</p>
        </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-start gap-2">
              <input
                type="checkbox"
                id="terms"
                className="mt-1 w-4 h-4 bg-white/5 border border-white/10 rounded text-purple-500 focus:ring-purple-500 focus:ring-offset-0"
                required
              />
